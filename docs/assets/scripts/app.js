	            ...
	            this.itemstoReveal.each(function () {
	                ...
	                new Waypoint({
	                    ...
	                    handler: function handler() {
	                        (0, _jquery2.default)(currentItem).addClass("manipulate-item-on-scroll--is-visible");
	                    },
	...
	var Modal = function () {
	    ...
	    _createClass(Modal, [{
	        ...
	        value: function openModal() {
	            ...
	            //return false removes default behaviour of # sign to scroll up to the top
	            return false;
	        }
	    }, {
	        key: "closeModal",
